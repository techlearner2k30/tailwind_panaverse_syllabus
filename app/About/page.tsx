export default function About() {
    return (
        <>
            <div className="relative flex min-h-screen flex-col justify-center overflow-hidden bg-gray-50 py-4 sm:py-4 shadow-lg">
                <div className="relative bg-white px-6 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:mx-auto sm:max-w-4xl sm:rounded-lg sm:px-10">
                    <div className="mx-auto">
                       
                        <div className="divide-y divide-gray-300/50">
                            <h1 className='text-4xl text-black py-4 text-center font-bold'>About Us</h1>
                            <div className="space-y-6 py-8 text-base leading-7 text-gray-600">
                                ...
                                <h2 className='text-2xl text-green py-4 text-center font-bold'>The Program in a Nutshell: Earn While You Learn</h2>
                                ...
                                <h2 className='text-2xl text-green py-4 text-center font-bold'>Program of Studies</h2>
